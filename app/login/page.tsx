          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="glass rounded-xl p-3 text-xs text-white/40 space-y-1">
                <p className="font-medium text-white/50">Backend login:</p>
                <p>Use a real IITB email account that exists in the backend database.</p>
                <p className="text-white/25 mt-1">This page now uses the real API, not demo auth.</p>
              </div>
